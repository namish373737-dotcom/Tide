...
import { Home, BarChart3, Calendar, Settings, CalendarDays } from 'lucide-react-native';
...
export default function TabLayout() {
  return (
    ...
    >
      ...
      <Tabs.Screen name="cycle" options={{ title: 'Cycle', tabBarIcon: ({ color, size }: { color: any; size: number }) => <CalendarDays size={size} color={color} /> }} />
